...
def cont_days():        # function to continue or end program
    ...
    if cont_progress == 'y':        # continue to main
        ...
        cont_progress = input('Do you want to select another day? \'y or n\': ')    # re-enter option
        print()
        if cont_progress == 'y':
            main()
        elif cont_progress == 'n':
            print('End of program.')
