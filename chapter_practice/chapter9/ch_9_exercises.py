...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', 'Emma': 'August 6', 'Ernie': 'May 1', 'Elsa': 'July 4'}

"""
input_name = input("Name: ")
input_bday = input(input_name + " birthday: ")
birthdays[input_name] = str(input_bday)
"""
...
for ln in miles_ridden:
    print(ln, miles_ridden[ln])
...
for val in miles_ridden:
    print(val, miles_ridden.get(val, 'Entry not found'))
...
for key, vl in miles_ridden.items():
    print(key, vl)
...
output_file = open('miles_ridden.bat', 'wb')
