...
divide = num1 // num2
remainder = num1 % num2
print("7 / 2 =", divide, "with a remainder of", remainder, "\n\n")
...
print("Hi " + user_name + ", welcome to our lesson.\n\n")
